...
var DEMO = {
  ...
  Initialize: function () {
    ...
    this.ms_Camera = new THREE.PerspectiveCamera(55, window.innerWidth / window.innerHeight, 1, 20000);
    this.ms_Camera.position.set(30, 30, 100);
    ...
    this.ms_Sky = new Sky();
    this.ms_Sky.scale.setScalar(10000);
    this.ms_Scene.add(this.ms_Sky);

    this.ms_Sky.material.uniforms[ 'turbidity' ].value = 10;
    this.ms_Sky.material.uniforms[ 'rayleigh' ].value = 2;
    this.ms_Sky.material.uniforms[ 'mieCoefficient' ].value = 0.005;
    this.ms_Sky.material.uniforms[ 'mieDirectionalG' ].value = 0.8;
  ...
  Update: function () {
    ...
    this.ms_Ocean.deltaTime = (currentTime - lastTime) / 6000 || 0.0;
